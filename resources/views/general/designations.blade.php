...
@section('content')
<form id="formAttendanceReason" class="mb-3" action="{{url('/designation-management')}}" method="POST">
    @if(session('success'))
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card-body">
                    ...
                    <div class="mt-2 mb-3">
                        ...
                        <input type="text" class="form-control" id="designation" name="designation" placeholder="Enter"
                            autofocus>
                    </div>
                </div>
            </div>
