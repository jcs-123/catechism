...
@section('content')
    <h3>Register Number Generation</h3>
    <form id="formAuthentication" class="mb-3" action="{{url('/register-no-generation')}}" method="POST">
        @csrf
        <div class="card">
            note: please make sure previous year mark entry and contact class attendance is done before register number
            generation. Register numbers will be generated for contact students with full attendance.
            <div class="row gy-4">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card-body">
                        <!-- <small class="text-light fw-medium">Academic Year</small> -->
                        <div class="mt-2 mb-3">
                            <label for="initial_reg_no">Initial Register Number</label>
                            <input type="number" class="form-control" id="initial_reg_no" name="initial_reg_no"
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card-body">
                        <!-- <div class="mt-6 mb-3"> -->
                        <button class="btn btn-primary d-grid w-70" type="submit">Generate Register Number</button>
                    </div>
                </div>
            </div>
        </div>
