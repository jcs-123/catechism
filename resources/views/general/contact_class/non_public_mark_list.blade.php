...
@section('content')
    <h3>Non Public Mark List</h3>
    <form id="formAuthentication" class="mb-3" action="{{url('/non-public-mark-list')}}" method="POST">
        @csrf
        <div class="card">
            <div class="row gy-4">
    ...
    @if(isset($students_data) && $students_data != '')
        ...
        <div class="container mt-4">
            <h4 class="mb-3 text-center">Internal Marks Report</h4>
