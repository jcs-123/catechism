...
@section('content')
    <h3>Add Contact Class Attendance</h3>
    <form id="formAuthentication" class="mb-3" action="{{url('/add-contact-attendance')}}" method="POST">
        @csrf
        <div class="card">
            <div class="row gy-4">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card-body">
                        <!-- <small class="text-light fw-medium">Academic Year</small> -->
                        <div class="mt-2 mb-3">
                            <label for="cc_date">Contact Class Date</label>
                            <input type="date" class="form-control" id="cc_date" name="cc_date" placeholder="Enter"
                                autofocus>
                        </div>
                    </div>
                </div>
