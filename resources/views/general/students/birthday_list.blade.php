...
@section('content')
    ...
    @endif
    <h5 class="mt-4 mb-3">STUDENTS BIRTHDAY LIST </h5>

    <form id="formAuthentication" class="mb-3" action="{{url('/birthday-list')}}" method="POST">
        @csrf
        <div class="card p-3">
            <div class="row gy-4">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach($students_attendance as $data)
