...
@section('content')
    <form id="formAuthentication" class="mb-1" action="{{url('/extra-attendance')}}" method="POST">
        @csrf
        <div class="card">
            <div class="row gy-1">
                @if(session('success'))
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Extra Attendance by HM</th>
                                    <th>Extra Attendance by Vicar</th>
                                    <th>Extra Attendance by DBDLC</th>
                                    <th>Total</th>
                                </tr>
                            </thead>
                            <tbody class="table-border-bottom-0">
                                @foreach($students as $ind => $stud)
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <input type="number" name="stud[{{$stud->adm_no}}][extra_attd_hm]" class="form-control">
                                        </td>
                                        <td>
                                            <input type="number" name="stud[{{$stud->adm_no}}][extra_attd_vicar]"
                                                class="form-control">
                                        </td>
                                        <td>
                                            <input type="number" name="stud[{{$stud->adm_no}}][extra_attd_dbclc]"
                                                class="form-control">
                                        </td>
                                        <td>
                                            <input type="number" name="stud[{{$stud->adm_no}}][total]" class="form-control">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
