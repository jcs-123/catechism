...
@section('content')
    <form id="formAuthentication" class="mb-3" action="{{url('/student-summary-report')}}" method="POST">
        @csrf
        <div class="card">
            <div class="row gy-6">
    ...
    @if(isset($student_summary) && !empty($student_summary))
        ...
        <div class="card">
            ...
            <div class="app-brand justify-content-center mt-2">
                <h5 class="text-center text-primary ">STUDENT SUMMARY REPORT
                </h5>
            </div>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table" id="example">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($student_summary as $key => $data)
                            <tr>
                                <td>{{$loop->iteration}}</td>
                                </td>
                                <td>{{$data['class']}}</td>
                                <td>{{$data['division_count']}}</td>
                                <td>{{$data['m_boys_count']}}</td>
                                <td>{{$data['m_girls_count']}}</td>
                                <td>{{$data['e_boys_count']}}</td>
                                <td>{{$data['e_girls_count']}}</td>
                                <td>{{$data['m_total']}}</td>
                                <td>{{$data['e_total']}}</td>
