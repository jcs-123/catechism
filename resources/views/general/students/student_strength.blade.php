...
@section('content')
    <form id="formAuthentication" class="mb-3" action="{{url('/student-strength')}}" method="POST">
        @csrf
        <div class="card">
            <div class="row gy-6">
    ...
    @if(isset($students_strength) && !empty($students_strength))
        ...
        <div class="card">
            ...
            <div class="app-brand justify-content-center mt-2">
                <h5 class="text-center text-primary ">STUDENT STRENGTH
                </h5>
            </div>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table" id="example">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($students_strength as $key => $data)
                            <tr>
