...
@section('content')
    ...
    <form id="formAuthentication" class="mb-3" action="{{url('/annual-exam-ineligibility-list')}}" method="POST">
        @csrf
        <div class="card p-3">
            <div class="row gy-4">
    ...
    <div class="card">
        <h5 class="card-header">Extra Attendance List</h5>
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach($studentexta_Attendance as $name => $attendance)
