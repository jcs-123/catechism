...
@section('content')
<form id="formAuthentication" class="mb-3" action="{{url('/add-news')}}" method="POST" enctype="multipart/form-data">
    @csrf
    @if ($errors->any())
            ...
            <div class="card-body">
                <div class=" col-md-12 ">
                    ...
                    <div class="mt-2 mb-4  col-md-6 float-right">
                        ...
                        <input type="text" class="form-control" id="discription" name="discription" placeholder="Enter"
                            autofocus>
                    </div>
                </div>
                ...
                <div class=" col-md-12">
                    <div class="mt-2 mb-4  col-md-6 float-left">
                        ...
                        <input type="text" class="form-control" id="hyperlink" name="hyperlink" placeholder="Enter"
                            autofocus>
                    </div>

                    <div class="mt-2 mb-4   col-md-6 float-right ">
                        <label for="hyperlink_text">Hyperlink Text</label>
                        <input type="text" class="form-control" id="hyperlink_text" name="hyperlink_text"
                            placeholder="Enter" autofocus>
                    </div>
                </div>
                ...
                <div class=" col-md-12 ">
                    <div class="mt-2 mb-4  col-md-6 float-left">
                        <label for="discription">Status</label>
                        <input type="text" class="form-control" id="discription" name="discription" placeholder="Enter"
                            autofocus>
                    </div>
                </div>
