...
@section('content')
<form id="formAuthentication" class="mb-1" action="{{url('/add-excellence-students')}}" method="POST">
    @csrf
    <div class="card">
        <div class="row gy-1">
            @if(session('success'))
            ...
            <div class="col-md-12 col-lg-4" id="class_div">
                <div class="card-body">
                    ...
                    <div class="mt-2 mb-3">
                        ...
                        <select id="criteria" name="criteria" class="form-select form-select-lg">
                            @foreach($criterias as $critr)
                                <option value="{{ $critr->id }}">
                                    {{ $critr->type_title }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap ml-2">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0 ml-2">
                            @foreach($students as $key => $data)
                                <tr>
                                    <td><input class="form-check-input" type="checkbox" name="students_code[]"
                                            value="{{ $key}}">{{$data}}
                                    </td>
