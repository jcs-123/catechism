...
@section('content')
<form id="formAttendanceReason" class="mb-3" action="{{url('/job-titles')}}" method="POST">
    @if(session('success'))
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card-body">
                    ...
                    <div class="mt-2 mb-3">
                        ...
                        <input type="text" class="form-control" id="job_name" name="job_name" placeholder="Enter"
                            autofocus>
                    </div>
                </div>
            </div>
