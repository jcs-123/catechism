...
@section('content')
    ...
    @endif
    <h5 class="mt-4 mb-3">STAFFS BIRTHDAY REPORT </h5>

    <form id="formAuthentication" class="mb-3" action="{{url('/staff-birthday-report')}}" method="POST">
        @csrf
        <div class="card p-3">
            <div class="row gy-4">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card-body">
                        <div class="mt-2 mb-3">
                            ...
                            <select class="form-select form-select-lg" id="month" name="month" autofocus>
                                <option value="" disabled selected>Select Month</option>
                                @foreach($months as $month)
                                    <option value="{{ $month->m_id }}">{{ $month->month }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
    ...
    <div class="card">
        <h5 class="card-header">Birthday List</h5>
