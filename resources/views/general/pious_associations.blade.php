...
@section('content')
<form id="formAttendanceReason" class="mb-3" action="{{url('/pious-associations')}}" method="POST">
    @if(session('success'))
        ...
        <div class="row gy-4">
            <div class="col-md-12 col-lg-4">
                <div class="card-body">
                    ...
                    <div class="mt-2 mb-3">
                        <label for="pious_assoc_name">Name Of Pious Association</label>
                        <input type="text" class="form-control" id="pious_assoc_name" name="pious_assoc_name"
    ...
    <div class="table-responsive text-nowrap">
        <table class="table" id="example">
            <thead>
                <tr>
                    <th>Slno</th>
                    <th>Pious Association Name</th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody class="table-border-bottom-0">
                @foreach($pious_assoc_data as $data)
