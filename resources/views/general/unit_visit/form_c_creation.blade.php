...
@section('content')
    <form id="formAttendanceReason" class="mb-3" action="{{url('/form-c')}}" method="POST">
        @if(session('success'))
                ...
                <div class="col-md-12 col-lg-4" id="forane_div">
                    <div class="card-body">
                        ...
                        <div class="mt-2 mb-3">
                            ...
                            <select id="section" name="section" class="form-select form-select-lg">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card-body">
                        ...
                        <div class="mt-2 mb-3">
                            ...
                            <input type="text" class="form-control" id="question" name="question" placeholder="Enter"
                                autofocus>
                        </div>
                    </div>
                </div>
