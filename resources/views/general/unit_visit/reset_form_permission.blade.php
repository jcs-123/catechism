...
@section('content')
    <form id="formAuthentication" class="mb-1" action="{{url('/reset-form-permission')}}" method="POST">
        @csrf
        <div class="card">
            <div class="row gy-1">
                @if ($errors->any())
                ...
                <div class="col-md-12 col-lg-3">
                    <div class="card-body">
                        <!-- <small class="text-light fw-medium">Academic Year</small> -->
                        <div class="mt-2 mb-3">
                            <label for="reset_form" class="form-label">Form To Be Reset</label>
                            <select id="reset_form" name="reset_form" class="form-select form-select-lg">
