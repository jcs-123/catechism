...
@section('content')
<form id="formAttendanceReason" class="mb-3" action="{{url('/qualification-management')}}" method="POST">
    @if(session('success'))
    ...
    <div class="card">
        <div class="row gy-4">
            ...
            <div class="col-md p-4">
                <small class="text-light fw-medium d-block">Type of Qualification</small>
                <div class="form-check form-check-inline mt-3">
                    <input class="form-check-input" type="radio" name="qualification_type" id="religious"
                        value="Religious">
                    <label class="form-check-label" for="religious1">Religious</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="qualification_type" id="secular" value="Secular">
                    <label class="form-check-label" for="secular1">Secular</label>
                </div>
            </div>
            <div class="col-md-12 col-lg-3">
                <div class="card-body">
